...
VENUE_OPEN_MSG = emojize('The restaurant {restaurant_name} is open right now! :hamburger: :yum:')
WELCOME_MSG = emojize("Hi!\n"
                      "I'm sure you are hungry!\n"
                      "Please enter restaurant url from wolt.com or type in the name, and i'll let you know when the venue is open :yum: \n")
WOLTDATER_API_TOKEN_KEY = 'WOLTDATER_API_TOKEN'
RESTAURANT_NOT_FOUND_MSG = emojize('Restaurant was not found! :cry:')
WILL_UPDATE_MSG = "I'll let you know when {restaurant_name} is open!"
